...
Block.prototype.end = function(){
    ...
    if( !document.getElementById("againMask") ){
        ...
        // againMask.innerHTML =
        '<div id="gove" ><h2 id="againSum">哇塞!你只抢到了'+_t.sum+'个智能球</h2><h1>简极科技-思远</h1><span id="againStart"><img src="img/e1.png"></span><span id="againStart_two"><img src="img/e2.png"></span><div>';
    ...
    if(0<_t.sum<=4){
        againMask.innerHTML =
            '<div id="gove" ><h2 id="againSum">哇塞!你抢到了'+_t.sum+'智能球</h2><h1>简极科技-思远</h1><span id="againStart"><img src="img/e1.png"></span><span id="againStart_two"><img src="img/e2.png"></span><div>';
    ...
    if(_t.sum>=5){
        againMask.innerHTML =
            '<div id="gove" ><h2 id="againSum">哇抢到了'+_t.sum+'智能球</h2><h1>简极科技-思远</h1><span id="againStart"><img src="img/e1.png"></span><span id="againStart_two"><img src="img/e2.png"></span><div>';
